return {
	{
		...
		config = function()
			...
			-- also use ctrl-j/k since tab might interfere with copilot
			...
			-- keyset("i", "<c-space>", "coc#refresh()", {remap = false, silent = true, expr = true})
			...
			keyset("x", "<space>f", ":Format<CR>", {silent = true})
			keyset("n", "<space>f", ":Format<CR>", {silent = true})
			...
			keyset("n", "<space><space>", ":<C-u>CocList diagnostics<cr>", opts)
			-- Manage extensions.
